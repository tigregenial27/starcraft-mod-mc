...
public class ZerglingEntity extends Monster {
	public ZerglingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarcraftModEntities.ZERGLING.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starcraft:zerlingliving"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starcraft:zerglingded"));
	}
