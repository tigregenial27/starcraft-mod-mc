...
public class GoliathvehicleEntity extends PathfinderMob implements RangedAttackMob {
	public GoliathvehicleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarcraftModEntities.GOLIATHVEHICLE.get(), world);
	}

	public GoliathvehicleEntity(EntityType<GoliathvehicleEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(2f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StarcraftModItems.GOLIATHREIDEABLEITEM.get()));
	}
