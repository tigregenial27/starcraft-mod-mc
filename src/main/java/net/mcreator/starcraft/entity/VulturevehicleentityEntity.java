...
public class VulturevehicleentityEntity extends PathfinderMob implements RangedAttackMob {
	public VulturevehicleentityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarcraftModEntities.VULTUREVEHICLEENTITY.get(), world);
	}

	public VulturevehicleentityEntity(EntityType<VulturevehicleentityEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(StarcraftModItems.VULTUREVEHICLE.get()));
	}
