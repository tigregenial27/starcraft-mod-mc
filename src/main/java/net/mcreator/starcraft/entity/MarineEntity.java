...
public class MarineEntity extends PathfinderMob implements RangedAttackMob {
	public MarineEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StarcraftModEntities.MARINE.get(), world);
	}
	...
	public MarineEntity(EntityType<MarineEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(StarcraftModItems.FUSILGAUS.get()));
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starcraft:marineliving"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("starcraft:marinedead"));
	}
